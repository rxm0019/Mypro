...
<div class="layui-fluid">
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <div style="padding-bottom: 10px;" id="sysHospitalList_tool">
                <button :visible="@baseFuncInfo.authorityTag('sysHospitalList#batchDel')"
            ...
            <script type="text/html" id="sysHospitalList_bar">
                ...
                {{#  } }}
                {{#  if(baseFuncInfo.authorityTag('sysHospitalList#del')){ }}
