 ...
 * @version 1.0
 */
var diaVascularLocusHisList = avalon.define({
...
layui.use(['index'],function(){
    ...
    avalon.ready(function () {
        ...
        diaVascularLocusHisList.vascularRoadId = vascularRoadId;
...
function getList() {
    var param = {
        vascularRoadId: diaVascularLocusHisList.vascularRoadId
    }
    //获取layui的table模块
    ...
    var util = layui.util;
    _layuiTable({
        elem: '#diaVascularLocusHisList_table', //必填，指定原始表格元素选择器（推荐id选择器）
        filter: 'diaVascularLocusHisList_table', ////必填，指定的lay-filter的名字
        //执行渲染table配置
        render: {
            ...
            cols: [[ //表头
                ...
                ,{fixed: 'right', title: '操作', width: 80, align: 'center', toolbar: '#diaVascularLocusHisList_bar'}
            ]]
        },
                    ...
                    if (isNotEmpty(data.vascularLocusHisId)) {
                        _ajax({
                            ...
                            dataType: "json",
                                ...
                                table.reload('diaVascularLocusHisList_table'); //重新刷新table
                            }
                        });
                    }
                });
    ...
    //监听表格checkbox
    table.on('row(diaVascularLocusHisList_table)', function(obj){
