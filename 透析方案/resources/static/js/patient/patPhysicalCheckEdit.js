/**
 * patPhysicalCheckEdit.jsp的js文件，包括查询，编辑操作
 */
var patPhysicalCheckEdit = avalon.define({
    $id: "patPhysicalCheckEdit",
...
function  getInfo(id,$callback){
    if(isEmpty(id)){
        ...
        _ajax({
            ...
            url: $.config.services.dialysis + "/patPhysicalCheck/getInfo.do",
            data:param,
            dataType: "json",
            done:function(data){
                //表单初始赋值
...
function save($callback){  //菜单保存操作
    ...
    verify_form(function(field){
        ...
        _ajax({
            ...
            url: $.config.services.dialysis + "/patPhysicalCheck/saveOrEdit.do",
            data:param,
            dataType: "json",
            done:function(data){
