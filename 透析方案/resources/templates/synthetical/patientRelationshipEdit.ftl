...
<body ms-controller="patientRelationshipEdit">
<div class="layui-card-body" style="padding: 10px;">
    <div class="layui-form" lay-filter="patientRelationshipEdit_form" id="patientRelationshipEdit_form" style="padding: 0 30px 0 0;">
        ...
        <div class="layui-row layui-col-space1">
                ...
                <div class="layui-row layui-col-space1">
                    <div class="layui-col-sm4 layui-col-md4 layui-col-lg4">
                        <div class="disui-form-flex" >
                            ...
                            <input type="text" name="patientName" maxlength="255" lay-verify="required" autocomplete="off">
                        </div>
                    </div>
                    <div class="layui-col-sm4 layui-col-md4 layui-col-lg4">
                        <div class="disui-form-flex" >
                    ...
                    <div class="layui-col-sm4 layui-col-md4 layui-col-lg4">
                        <div class="disui-form-flex" >
                            ...
                            <input type="text" name="birthday" lay-verify="required" id="birthday" placeholder="yyyy-MM-dd" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="layui-row layui-col-space1">
                    <div class="layui-col-sm4 layui-col-md4 layui-col-lg4">
                        <div class="disui-form-flex" >
                            ...
                            <select name="idCardType" id="idCardType" lay-verify="required" lay-filter="idCardType">
                                <option value=""></option>
                                <option  ms-attr="{value:el.value}" ms-text="@el.name"
                    ...
                    <div class="layui-col-sm4 layui-col-md4 layui-col-lg4">
                        <div class="disui-form-flex" >
                            <input type="text" name="idCardNo" id="idCardNo" maxlength="50" lay-verify="required|IdCodeValids" autocomplete="off">
                        </div>
                    </div>
                    <div class="layui-col-sm4 layui-col-md4 layui-col-lg4">
                        <div class="disui-form-flex" >
            ...
            <div class="layui-col-sm3 layui-col-md3 layui-col-lg3">
                <div class="layui-row layui-col-space1">
                    ...
                    <#--<input type="hidden" name="patientPhoto"  placeholder="请输入" autocomplete="off">-->
        ...
        <div class="layui-row layui-col-space1">
            <div class="layui-col-sm6 layui-col-md6 layui-col-lg6">
                <div class="disui-form-flex">
                    ...
                    <select name="insuranceTypes" lay-verify="required" xm-select="insuranceTypes" xm-select-search="" xm-select-search-type="dl" xm-select-height="36px" style="width: inherit;">
                        <option value=""></option>
                        <option  ms-attr="{value:el.value}" ms-text="@el.name"
            ...
            <div class="layui-col-sm6 layui-col-md6 layui-col-lg6">
                <div class="disui-form-flex" >
                    ...
                    <input type="text" name="socialSecurityNo" maxlength="50" lay-verify="required" placeholder="请输入" autocomplete="off" >
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space1">
            <div class="layui-col-sm3 layui-col-md3 layui-col-lg3">
                <div class="disui-form-flex" >
                    ...
                    <select name="ethnicity" lay-verify="required">
                        <option value=""></option>
                        <option  ms-attr="{value:el.value}" ms-text="@el.name"
            ...
            <div class="layui-col-sm3 layui-col-md3 layui-col-lg3">
                <div class="disui-form-flex" >
                    <label>身高：</label>
                    <input type="text" name="stature"  lay-verify="stature" maxlength="3" placeholder="请输入" autocomplete="off" style="float:left;width: 80%">
            ...
            <div class="layui-col-sm3 layui-col-md3 layui-col-lg3">
                <div class="disui-form-flex" >
                    <label>入院体重：</label>
                    <input type="text" name="admissionWeight" lay-verify="number" maxlength="3" placeholder="请输入" autocomplete="off"  style="float:left;width: 80%">
        ...
        <div class="layui-row layui-col-space1">
            <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
                <div class="disui-form-flex" >
                    <label>特殊要求：</label>
                    <textarea name="specialRequirements" maxlength="65535"  placeholder="请输入"></textarea>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space1">
        ...
        <div class="layui-row layui-col-space1">
            <div class="layui-col-sm3 layui-col-md3 layui-col-lg3">
                <div class="disui-form-flex" >
                    ...
                    <input type="text" name="mobilePhone" maxlength="20" lay-verify="required|phone" placeholder="请输入" autocomplete="off">
                </div>
            </div>
            <div class="layui-col-sm4 layui-col-md3 layui-col-lg3">
                <div class="disui-form-flex">
                    <label>固定电话：</label>
                    <input type="text" name="fixedPhoneFront" maxlength="4" placeholder="请输入" autocomplete="off" >
                    <label>-</label>
                </div>
            </div>
            <div class="layui-col-sm6 layui-col-md6 layui-col-lg4">
                <div class="disui-form-flex">
                    <input type="text" name="fixedPhoneLast" maxlength="8" placeholder="请输入" autocomplete="off">
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space1">
            ...
            <div class="layui-col-sm6 layui-col-md6 layui-col-lg6">
                <div class="disui-form-flex" >
                    <input type="text" name="contactAddress" maxlength="200">
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space1">
            ...
            <div class="layui-col-sm6 layui-col-md6 layui-col-lg6">
                <div class="disui-form-flex" >
                    <input type="text" name="homeAddress" maxlength="200">
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space1">
     ...
     layui-btn-dissmall layui-btn-xs layui-btn-dis-black" lay-event="del">删除</a>
        ...
        <div class="layui-row layui-col-space1">
            <div class="layui-col-sm3 layui-col-md3 layui-col-lg3">
                <div class="disui-form-flex" >
                    <label>透析次数：</label>
                    <input type="text" readonly name="dialysisTimes" readonly placeholder="请输入" autocomplete="off">
                </div>
            </div>
            <div class="layui-col-sm3 layui-col-md3 layui-col-lg3">
                <div class="disui-form-flex" >
            ...
            <div class="layui-col-sm3 layui-col-md3 layui-col-lg3">
                <div class="disui-form-flex" >
                    ...
                    <select name="dialysisTotalFrequency" lay-verify="required">
                        <option value=""></option>
                        <option  ms-attr="{value:el.value}" ms-text="@el.name"
        ...
        <div class="layui-row layui-col-space1 layui-hide">
            <button class="layui-btn" lay-submit lay-filter="patientRelationshipEdit_submit" id="patientRelationshipEdit_submit">提交</button>
        </div>
    </div>
</div>
<script type="text/javascript" src="${ctxsta}/static/js/synthetical/patientRelationshipEdit.js?t=${currentTimeMillis}"></script>
<!-- 自定义下拉菜单内容 -->
