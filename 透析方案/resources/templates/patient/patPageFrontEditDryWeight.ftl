...
<body ms-controller="patPageFrontDryWeightEdit">
    ...
    <div class="layui-row layui-col-space1">
        <div class="layui-col-sm3 layui-col-md3 layui-col-lg3">
            <div class="disui-form-flex">
                ...
                <input type="text" name="adjustValue" maxlength="6" id="adjustValue"  lay-verify="weight|required"
                       autocomplete="off"
                       :attr="@disabled">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-hide">
            <button class="layui-btn" lay-submit lay-filter="patPageFrontDryWeightEdit_submit" id="patPageFrontDryWeightEdit_submit">提交</button>
        </div>
</div>
<script type="text/javascript" src="${ctxsta}/static/js/patient/patPageFrontEditDryWeight.js?t=${currentTimeMillis}"></script>
</body>
</html>