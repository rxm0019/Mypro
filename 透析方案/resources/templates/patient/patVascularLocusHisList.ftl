...
<body ms-controller="patVascularLocusHisList">
<div class="layui-fluid" style="height: 500px;">
    <div class="layui-row layui-col-space1">
        <div class="layui-col-sm6 layui-col-md6 layui-col-lg6" style="padding-right: 20px;">
            ...
            <table id="patVascularLocusHisList_table" lay-filter="patVascularLocusHisList_table"></table>
        </div>
    ...
    <script type="text/html" id="patVascularLocusHisList_bar">
        {{#  if(baseFuncInfo.authorityTag('patVascularLocusHisList#delete')){ }}
            <a class="layui-btn layui-btn-dissmall layui-btn-xs layui-btn-dis-black" lay-event="delete">删除</a>
        {{#  } }}
    </script>
</div>
<script type="text/javascript" src="${ctxsta}/static/js/patient/patVascularLocusHisList.js?t=${currentTimeMillis}"></script>
</body>
</html>