...
<head>
    ...
    <style>
        ...
        .dis-partition-header .export-btn {
            font-size: 14px;
            height: 26px;
            line-height: 26px;
            width: auto;
        ...
        /** 阶段小结表格 **/
        .summary-table-box .disui-form-flex>input {
            flex: none;
            width: 80px;
        }
        .summary-table-box .disui-form-flex>label:last-child {
            flex: none;
            font-weight: bold;
            text-align: left;
            padding-left: 10px;
        }
        .summary-table-box .layui-table-view .layui-table td {
            border-right: none;
        }
...
<body ms-controller="patSummaryList">
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-body" style="padding: 10px;">
            <!--工具栏的按钮的div，注意：需要增加权限控制-->
            <div class="layui-row" id="patSummaryList_tool">
                <!-- 常规按钮 -->
                <div class="layui-col-sm3 layui-col-md3 layui-col-lg2">
                    <a :visible="@baseFuncInfo.authorityTag('patSummaryList#add')"
                            class="layui-btn layui-btn-dismain" href="javascript: onOpenAddSummaryWin()">添加</a>
                    <a :visible="@baseFuncInfo.authorityTag('patSummaryList#template')"
                            class="layui-btn layui-btn-dismain" href="javascript: onOpenSummaryTemplateWin()">模板管理</a>
                </div>
                <div class="layui-col-sm9 layui-col-md9 layui-col-lg10" style="text-align: right">
                    <!-- 阶段小结详情模式按钮 -->
                    <div ms-if="@patSummary && @patSummary.summaryId && !@isEditMode">
                        <a :visible="@baseFuncInfo.authorityTag('patSummaryList#edit')"
                                class="layui-btn layui-btn-dismain" href="javascript: renderCurrentPatSummary(true)">修改</a>
                        <a :visible="@baseFuncInfo.authorityTag('patSummaryList#print')"
                                class="layui-btn layui-btn-dissub" href="javascript: onOpenSummaryPrintWin()">打印</a>
                        <a :visible="@baseFuncInfo.authorityTag('patSummaryList#del')"
                                class="layui-btn layui-btn-dissub" href="javascript: deleteSummary()">删除</a>
                    </div>

                    <!-- 阶段小结编辑模式按钮 -->
                    <div ms-if="@patSummary && @patSummary.summaryId && @isEditMode">
                        <a class="layui-btn layui-btn-dismain" href="javascript: getPatSummaryTemplate()">从模板中导入</a>
                        <a class="layui-btn layui-btn-dismain" href="javascript: saveSummary()">保存</a>
                        <a class="layui-btn layui-btn-dissub" href="javascript: renderCurrentPatSummary(false)">取消</a>
                    </div>
                </div>
            </div>
            ...
            <div class="layui-row layui-col-space10 mt-5">
                <div class="layui-col-sm3 layui-col-md3 layui-col-lg2 summary-table-box">
                    <!-- 阶段小结查询 + 表格 -->
                    <div class="layui-row content-box">
                        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12 mb-5">
                            <div class="disui-form-flex" >
                                <input type="text" name="yearSearch" id="yearSearch" placeholder="yyyy" autocomplete="off">
                                <label>阶段小结</label>
                            </div>
                        </div>
                        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
                            <table id="patSummaryList_table" lay-filter="patSummaryList_table"></table>
                        </div>
                    </div>
                </div>
                <div class="layui-col-sm9 layui-col-md9 layui-col-lg10">
                    <!-- 阶段小结表单 -->
                    <form class="layui-form content-box" lay-filter="patSummaryEdit_form" id="patSummaryEdit_form">
                        <div class="layui-row">
                            <div class="layui-col-sm6 layui-col-md6 layui-col-lg6">
                                <div class="disui-form-flex" >
                                    <label>阶段小结：</label>
                                    <input type="text" name="summaryTitle" autocomplete="off" readonly >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="dis-partition-header">
                            ...
                            <a ms-if="!@formReadonly" class="layui-btn layui-btn-dismain layui-btn-dis-s export-btn" href="javascript: getDiaRecordLately()">获取最新透析概要</a>
                        </div>
                        <div class="layui-row">
                            ...
                            <div class="layui-col-sm9 layui-col-md9 layui-col-lg9">
                                <div class="disui-form-flex" >
                                    ...
                                    <input type="hidden" name="dialysisModeWithTimes"
                        ...
                        <div class="dis-partition-header">
                            ...
                            <a ms-if="!@formReadonly" class="layui-btn layui-btn-dismain layui-btn-dis-s export-btn" href="javascript: onOpenImportAssessWin()">从化验记录导入评估值</a>
                        </div>
                        <!-- 阶段小结表单 - 评估 - 1.肾性贫血评估 -->
                        <div class="layui-row assess-group">
                            ...
                            <div class="layui-col-sm6 layui-col-md4 layui-col-lg3">
                                <div class="disui-form-flex" ><label>血红蛋白：</label>
                                    <input type="text" name="hemoglobin" autocomplete="off" maxlength="8" ms-attr="{readonly: @formReadonly}"
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${ctxsta}/static/js/patient/patSummaryList.js?t=${currentTimeMillis}"></script>
</body>
</html>
