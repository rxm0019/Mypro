...
<body ms-controller="loginSwitch">
<!-- 权限设置表单 -->
<div class="layui-form layui-row layui-col-xs12 pd-10" lay-filter="loginSwitch_form" id="loginSwitch_form">
...
<script type="text/javascript" src="${ctxsta}/static/js/system/loginSwitch.js?t=${currentTimeMillis}"></script>
