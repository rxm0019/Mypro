...
<body ms-controller="diaEduShow">
<div class="layui-fluid">
    <div class="layui-form" lay-filter="diaEduShow_form" id="diaEduShow_form" style="background-color: white;height: calc(100vh - 20px);">
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${ctxsta}/static/js/dialysis/diaEduShow.js?t=${currentTimeMillis}"></script>
</body>
</html>