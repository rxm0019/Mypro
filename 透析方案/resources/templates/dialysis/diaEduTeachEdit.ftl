...
<body ms-controller="diaEduTeachEdit">
<div class="layui-card-body">
<div class="layui-form" lay-filter="diaEduTeachEdit_form" id="diaEduTeachEdit_form" style="padding: 20px 30px 0 0;">
    <div class="layui-row layui-col-space1">
        ...
        <div class="layui-form-item layui-hide">
            <button class="layui-btn" lay-submit lay-filter="diaEduTeachEdit_submit" id="diaEduTeachEdit_submit">提交</button>
        </div>
    </div>
</div>
<script type="text/javascript" src="${ctxsta}/static/js/dialysis/diaEduTeachEdit.js?t=${currentTimeMillis}"></script>
</body>
</html>