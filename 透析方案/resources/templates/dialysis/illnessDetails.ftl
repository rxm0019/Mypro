...
<body ms-controller="illnessDetails">
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-form layui-card-header layuiadmin-card-header-auto search-form">
            <div class="layui-row layui-col-space1">
                ...
                <div class="layui-col-sm3 layui-col-md3 layui-col-lg3">
                    <div class="disui-form-flex">
                        <label>日期：</label>
                        <input type="text" 　name="shiftDate" id="shiftDate">
                    </div>
                </div>
        ...
        <div class="layui-card-body">
            <table id="unusualList_table" lay-filter="unusualList_table"></table>
        </div>
    </div>
</div>
<script type="text/javascript" src="${ctxsta}/static/js/dialysis/illnessDetails.js?t=${currentTimeMillis}"></script>
</body>
</html>