...
<body ms-controller="diaEduTeachList">
<div class="layui-fluid" style="padding:0px 10px!important;background: white;">
    <div class="layui-card">
        ...
        <div class="layui-tab" lay-filter="teachTab" style="margin: 10px 0;">
            <ul class="layui-tab-title">
                ...
                <li>教育计划</li>
                <li>教育记录</li>
                <ol class="layui-tab" lay-filter="childTab" style="display: inline;">
                    <li style="cursor: default;" :visible="@principalNurse!=''">
                        责任护士：{{@principalNurse }}
                    </li>
                </ol>
            </ul>
                ...
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-card-body">
                        ...
                        <div ms-if="@searchTheme=='1'">
                            <div class="layui-row layui-col-space1 demo-list" style="height: calc(80vh - 50px);">
                    ...
                    <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-card-body">
                            ...
                            <div style="padding-bottom: 10px;" id="eduTeachPlanList_tool">
                                ...
                                <button :visible="@baseFuncInfo.authorityTag('diaEduTeachPlanList#addPlan')"
                                        class="layui-btn layui-btn-dismain"  onclick="batchAdd()">制定计划</button>
<#--                                <button :visible="@baseFuncInfo.authorityTag('diaEduTeachPlanList#wechat')"-->
<#--                                        class="layui-btn layui-btn-dissub"  onclick="sendWeChat()">微信推送</button>-->
                                <button :visible="@baseFuncInfo.authorityTag('diaEduTeachPlanList#type') && @sustainType==@changeType.keepPatient"
                                        class="layui-btn layui-btn-dissub"  onclick="changeType()">转新患者</button>
                                <button :visible="@baseFuncInfo.authorityTag('diaEduTeachPlanList#type') && @sustainType!=@changeType.keepPatient"
                                        class="layui-btn layui-btn-dissub"  onclick="changeType('1')">转维持患者</button>
                                <button :visible="@baseFuncInfo.authorityTag('diaEduTeachPlanList#delete')"
...
<script type="text/html" id="eduTeachThemeList_bar">
    {{#  if(baseFuncInfo.authorityTag('diaEduTeachList#edu')){ }}
...
<script type="text/html" id="eduTeachPlanList_bar">
    {{#  if(baseFuncInfo.authorityTag('diaEduTeachList#show')){ }}
    <a class="layui-btn layui-btn-dissmall layui-btn-xs layui-btn-dis-blue" lay-event="eduShow">预览</a>
    {{#  } }}
    {{#  if(baseFuncInfo.authorityTag('diaEduTeachList#edu')){ }}
    <a class="layui-btn layui-btn-dissmall layui-btn-xs layui-btn-dis-blue" lay-event="eduTheme">宣教</a>
    {{#  } }}
    {{#  if(baseFuncInfo.authorityTag('diaEduTeachPlanList#delete')){ }}
...
<script type="text/html" id="duTeachDetailList_bar">
    ...
    <a class="layui-btn layui-btn-dissmall layui-btn-xs layui-btn-dis-blue" lay-event="eduShow">预览</a>
    {{#  } }}
    {{#  if(baseFuncInfo.authorityTag('diaTeachDetailList#add')){ }}
    <a class="layui-btn layui-btn-dissmall layui-btn-xs layui-btn-dis-blue" lay-event="addTeach">测评</a>
    {{#  } }}
    {{#  if(baseFuncInfo.authorityTag('diaTeachDetailList#showTeach') && d.teachAssess != ""){ }}
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${ctxsta}/static/js/dialysis/diaEduTeachList.js?t=${currentTimeMillis}"></script>
</body>
</html>