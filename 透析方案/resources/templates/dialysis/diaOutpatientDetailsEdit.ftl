...
<body ms-controller="diaOutpatientDetailsEdit">
<div class="layui-form" lay-filter="diaOutpatientDetailsEdit_form" id="diaOutpatientDetailsEdit_form" style="padding: 20px;">
    <div class="layui-hide">
        <div class="layui-input-inline">
            <input type="hidden" name="detailsId" autocomplete="off" class="layui-input">
            <input type="hidden" name="parentDetailsId" autocomplete="off" class="layui-input">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-form-item layui-hide">
            <button class="layui-btn" lay-submit lay-filter="diaOutpatientDetailsEdit_submit" id="diaOutpatientDetailsEdit_submit">提交</button>
        </div>
    </div>
    <script type="text/javascript" src="${ctxsta}/static/js/dialysis/diaOutpatientDetailsEdit.js?t=${currentTimeMillis}"></script>
</div>
</body>
</html>