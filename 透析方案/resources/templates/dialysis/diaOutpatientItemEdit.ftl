...
<body ms-controller="diaOutpatientItemEdit">
<div class="layui-form" lay-filter="diaOutpatientItemEdit_form" id="diaOutpatientItemEdit_form" style="padding: 20px 30px 0 0;">
    ...
    <div class="layui-form-item layui-hide">
        <button class="layui-btn" lay-submit lay-filter="diaOutpatientItemEdit_submit" id="diaOutpatientItemEdit_submit">提交</button>
    </div>
</div>
<script type="text/javascript" src="${ctxsta}/static/js/dialysis/diaOutpatientItemEdit.js?t=${currentTimeMillis}"></script>
</body>
</html>