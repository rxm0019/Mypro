...
<body ms-controller="eduPlanEdit">
<div class="layui-card-body">
    <div class="layui-form" lay-filter="eduPlanEdit_form" id="eduPlanEdit_form" style="padding: 20px 30px 0 0;">
        <div class="layui-row layui-col-space1">
            ...
            <div class="layui-form-item layui-hide">
                <button class="layui-btn" lay-submit lay-filter="eduPlanEdit_submit" id="eduPlanEdit_submit">提交</button>
            </div>
        </div>
    </div>
</div>
<script type="text/javascript" src="${ctxsta}/static/js/education/eduPlanEdit.js?t=${currentTimeMillis}"></script>
</body>
</html>