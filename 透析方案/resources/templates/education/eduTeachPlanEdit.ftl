...
<body ms-controller="eduTeachPlanEdit">
<div class="layui-card-body">
    <div class="layui-form" lay-filter="eduTeachPlanEdit_form" id="eduTeachPlanEdit_form" style="padding: 20px 30px 0 0;">
        <div class="layui-row layui-col-space1">
            <div class="layui-row">
                <div class="disui-form-flex" >
                    <label class="layui-form-label"><span class="edit-verify-span">*</span>宣教患者：</label>
                    <select name="patientId" xm-select="patientId" xm-select-height="36px" xm-select-search="" lay-verify="required">
                    </select>
                </div>
            </div>
            <div class="layui-row">
            ...
            <div class="layui-form-item layui-hide">
                <button class="layui-btn" lay-submit lay-filter="eduTeachPlanEdit_submit" id="eduTeachPlanEdit_submit">提交</button>
            </div>
        </div>
    </div>
</div>
<script type="text/javascript" src="${ctxsta}/static/js/education/eduTeachPlanEdit.js?t=${currentTimeMillis}"></script>
</body>
</html>