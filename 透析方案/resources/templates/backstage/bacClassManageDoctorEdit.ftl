...
<body ms-controller="bacClassManageDoctorEdit">
<div class="layui-card-body">
    <div class="layui-form" lay-filter="bacClassManageDoctorEdit_form" id="bacClassManageDoctorEdit_form" style="padding: 20px 50px 0 50px;">
        <div class="layui-row layui-col-space1 demo-list">
            ...
            <div class="layui-col-sm12 layui-col-md12 layui-col-lg12" id="partTime">
                <div class="disui-form-flex" >
                    ...
                    <input type="text" name="classPart1" id="classPart1" lay-verify-msg="请选择时段" lay-verify="required" placeholder="HH:mm"  autocomplete="off"  >
                </div>
                <div class="disui-form-flex" id="addPartTime">
                    <label class="layui-form-label"> </label>
                    <button class="layui-btn layui-btn-dis-xs layui-btn-dis-seach layui-btn layui-btn-dismain" style="margin: 3px;width: 100%;" id="andSetTime" onclick="addSetTime()"><i class="layui-icon">&#xe654;</i></button>
                </div>
            </div>
            <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
                <div class="disui-form-flex" >
            ...
            <div class="layui-form-item layui-hide">
            <button class="layui-btn" lay-submit lay-filter="bacClassManageDoctorEdit_submit" id="bacClassManageDoctorEdit_submit">提交</button>
        </div>
    </div>
</div>
</div>
<script type="text/javascript" src="${ctxsta}/static/js/backstage/bacClassManageDoctorEdit.js?t=${currentTimeMillis}"></script>
</body>
</html>