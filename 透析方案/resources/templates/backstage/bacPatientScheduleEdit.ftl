...
<body ms-controller="bacPatientScheduleEdit">
<div class="layui-card-body">
<div class="layui-form" lay-filter="bacPatientScheduleEdit_form" id="bacPatientScheduleEdit_form" style="padding: 20px 100px 0 100px;">
    <div class="layui-row layui-col-space1 demo-list">
        <div class="layui-form-item  layui-hide">
            <label class="layui-form-label">ID</label>
            <div class="layui-input-inline">
                <input type="hidden" name="patientScheduleId"  autocomplete="off" >
            </div>
        </div>
        ...
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
            <div class="disui-form-flex" >
                ...
                <#--<input type="text" name="scheduleDate" lay-verify="required" id="scheduleDate" placeholder="yyyy-MM-dd" autocomplete="off" >-->
            </div>
        </div>
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
            <div class="disui-form-flex" >
        ...
        <#--<div class="layui-col-sm12 layui-col-md12 layui-col-lg12">-->
            <#--<div class="disui-form-flex" >-->
                <#--<label class="layui-form-label">治疗特征：</label>-->
                <#--<label class="layui-form-label" style="flex: auto;text-align: left;" ms-text="@features"></label>-->
            <#--</div>-->
        <#--</div>-->
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
            <div class="disui-form-flex" >
        ...
        <div class="layui-form-item layui-hide">
            <button class="layui-btn" lay-submit lay-filter="bacPatientScheduleEdit_submit" id="bacPatientScheduleEdit_submit">提交</button>
        </div>
    </div>
</div>
</div>
<script type="text/javascript" src="${ctxsta}/static/js/backstage/bacPatientScheduleEdit.js?t=${currentTimeMillis}"></script>
</body>
</html>