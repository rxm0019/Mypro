...
<body ms-controller="bacClassTemplateNurseEdit">
<div class="layui-card-body">
<div class="layui-form" lay-filter="bacClassTemplateNurseEdit_form" id="bacClassTemplateNurseEdit_form" style="padding: 20px;">
    <div class="layui-row layui-col-space1 demo-list">
        <div class="layui-form-item  layui-hide">
            <label class="layui-form-label">ID</label>
            <div class="layui-input-inline">
                <input type="hidden" name="classTemplateId" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-col-sm4 layui-col-md4 layui-col-lg4">
            <div class="disui-form-flex" >
                <label class="layui-form-label">默认区组：</label>
                <select  name="defaultPart" xm-select="defaultPart" xm-select-search="" xm-select-search-type="dl" xm-select-height="36px" style="width: inherit;">
                    <option value=""></option>
        ...
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
            <fieldset class="layui-elem-field layui-field-title" style="margin: 10px;">
                <legend style="font-size: 16px;"><span class="edit-verify-span">*</span>班种、区组</legend>
            </fieldset>
        </div>
        ...
        <div class="layui-col-sm3 layui-col-md2 layui-col-lg1">
            ...
            <div class="layui-col-sm12 layui-col-md12 layui-col-lg12" style="padding-top: 5px;">
                <select  name="partMon" xm-select="partMon" xm-select-search="" xm-select-search-type="dl" xm-select-height="36px" >
                    <option value=""></option>
                    <option  ms-for="($index,el) in @regionSettingList" ms-attr="{value: el.value}">{{el.name}}</option>
                </select>
            </div>
        ...
        <div class="layui-col-sm3 layui-col-md2 layui-col-lg1">
            ...
            <div class="layui-col-sm12 layui-col-md12 layui-col-lg12" style="padding-top: 5px;">
                <select  name="partTue" xm-select="partTue" xm-select-search="" xm-select-search-type="dl" xm-select-height="36px" >
                    <option value=""></option>
                    <option  ms-for="($index,el) in @regionSettingList" ms-attr="{value: el.value}">{{el.name}}</option>
                </select>
            </div>
        ...
        <div class="layui-col-sm3 layui-col-md2 layui-col-lg1">
            ...
            <div class="layui-col-sm12 layui-col-md12 layui-col-lg12" style="padding-top: 5px;">
                <select  name="partWed" xm-select="partWed" xm-select-search="" xm-select-search-type="dl" xm-select-height="36px" >
                    <option value=""></option>
                    <option  ms-for="($index,el) in @regionSettingList" ms-attr="{value: el.value}">{{el.name}}</option>
                </select>
            </div>
        ...
        <div class="layui-col-sm3 layui-col-md2 layui-col-lg1">
            ...
            <div class="layui-col-sm12 layui-col-md12 layui-col-lg12" style="padding-top: 5px;">
                <select  name="partThur" xm-select="partThur" xm-select-search="" xm-select-search-type="dl" xm-select-height="36px" >
                    <option value=""></option>
                    <option  ms-for="($index,el) in @regionSettingList" ms-attr="{value: el.value}">{{el.name}}</option>
                </select>
            </div>
        ...
        <div class="layui-col-sm3 layui-col-md2 layui-col-lg1">
            ...
            <div class="layui-col-sm12 layui-col-md12 layui-col-lg12" style="padding-top: 5px;">
                <select  name="partFri" xm-select="partFri" xm-select-search="" xm-select-search-type="dl" xm-select-height="36px" >
                    <option value=""></option>
                    <option  ms-for="($index,el) in @regionSettingList" ms-attr="{value: el.value}">{{el.name}}</option>
                </select>
            </div>
        ...
        <div class="layui-col-sm3 layui-col-md2 layui-col-lg1">
            ...
            <div class="layui-col-sm12 layui-col-md12 layui-col-lg12" style="padding-top: 5px;">
                <select  name="partSat" xm-select="partSat" xm-select-search="" xm-select-search-type="dl" xm-select-height="36px" >
                    <option value=""></option>
                    <option  ms-for="($index,el) in @regionSettingList" ms-attr="{value: el.value}">{{el.name}}</option>
                </select>
            </div>
        ...
        <div class="layui-col-sm3 layui-col-md2 layui-col-lg1">
            ...
            <div class="layui-col-sm12 layui-col-md12 layui-col-lg12" style="padding-top: 5px;">
                <select  name="partSun" xm-select="partSun" xm-select-search="" xm-select-search-type="dl" xm-select-height="36px" >
                    <option value=""></option>
                    <option  ms-for="($index,el) in @regionSettingList" ms-attr="{value: el.value}">{{el.name}}</option>
                </select>
            </div>
        ...
        <div class="layui-form-item layui-hide">
            <button class="layui-btn" lay-submit lay-filter="bacClassTemplateNurseEdit_submit" id="bacClassTemplateNurseEdit_submit">提交</button>
        </div>
    </div>
</div>
</div>
<script type="text/javascript" src="${ctxsta}/static/js/backstage/bacClassTemplateNurseEdit.js?t=${currentTimeMillis}"></script>
</body>
</html>