...
<body ms-controller="bacClassManageDoctorList">
<div class="layui-fluid">
    <div class="layui-card">

        <div class="layui-card-body">
            <!--工具栏的按钮的div，注意：需要增加权限控制-->
            <div style="padding: 10px;" id="bacClassManageDoctorList_tool">
            ...
            <script type="text/html" id="bacClassManageDoctorList_bar">
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${ctxsta}/static/js/backstage/bacClassManageDoctorList.js?t=${currentTimeMillis}"></script>
</body>
</html>