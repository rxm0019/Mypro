...
<body ms-controller="doctorDutyEdit">
<div class="layui-card-body">
    <div class="layui-form" lay-filter="doctorDutyEdit_form" id="doctorDutyEdit_form" style="padding: 20px 50px 0 50px;">
        <div class="layui-row layui-col-space1 demo-list">
            ...
            <div class="layui-col-sm12 layui-col-md12 layui-col-lg12 layui-hide" id="hidePer">
                <div class="disui-form-flex" >
                    <label class="layui-form-label"><span class="edit-verify-span">*</span>交换医生：</label>
            ...
            <div class="layui-form-item layui-hide">
                <button class="layui-btn" lay-submit lay-filter="doctorDutyEdit_submit" id="doctorDutyEdit_submit">提交</button>
            </div>
        </div>
    </div>
</div>
<script type="text/javascript" src="${ctxsta}/static/js/backstage/doctorDutyEdit.js?t=${currentTimeMillis}"></script>
</body>
</html>