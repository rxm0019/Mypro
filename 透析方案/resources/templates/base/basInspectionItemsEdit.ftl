...
<body ms-controller="basInspectionItemsEdit">
<div class="layui-card-body" style="padding: 15px;">
    <div class="layui-form" lay-filter="basInspectionItemsEdit_form" id="basInspectionItemsEdit_form"
         style="padding: 20px 30px 0 0;">
        <div class="layui-row layui-col-space1">
            <div class="layui-form-item  layui-hide">
                <label >ID</label>
                <div class="layui-input-inline">
                    <input type="hidden" name="inspectionItemsId" autocomplete="off"
                           :attr="@readonly">
                </div>
            </div>
            <div class="layui-col-sm6 layui-col-md6 layui-col-lg6">
                <div class="disui-form-flex">
                    <label ><span class="edit-verify-span">*</span>检查项目编码：</label>
                    <input type="text" name="itemNo" maxlength="32" lay-verify="required"
                           autocomplete="off" :attr="@itemNo" ms-duplex="inspectionNo">
                </div>
            </div>
            <div class="layui-col-sm6 layui-col-md6 layui-col-lg6">
                <div class="disui-form-flex">
                    <label ><span class="edit-verify-span">*</span>检查项目名称：</label>
            ...
            <div class="layui-col-sm6 layui-col-md6 layui-col-lg6">
                <div class="disui-form-flex">
                    <label ><span class="edit-verify-span">*</span>检查项目规格：</label>
            ...
            <div class="layui-form-item layui-hide">
                <button class="layui-btn" lay-submit lay-filter="basInspectionItemsEdit_submit"
                        id="basInspectionItemsEdit_submit">提交
                </button>
            </div>
        </div>
    </div>
...
<script type="text/javascript"
        src="${ctxsta}/static/js/base/basInspectionItemsEdit.js?t=${currentTimeMillis}"></script>
</body>
</html>