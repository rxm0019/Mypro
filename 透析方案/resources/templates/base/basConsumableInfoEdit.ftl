...
<body ms-controller="basConsumableInfoEdit">
<div class="layui-card-body" style="padding: 15px;">
<div class="layui-form" lay-filter="basConsumableInfoEdit_form" id="basConsumableInfoEdit_form" style="padding: 20px 30px 0 0;">
    <div class="layui-row layui-col-space1">
    <div class="layui-form-item  layui-hide">
            <label>ID</label>
            <div class="disui-form-flex">
                <input type="hidden" name="consumableInfoId" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-col-sm6 layui-col-md4 layui-col-lg3">
            <div class="disui-form-flex">
                <label><span class="edit-verify-span">*</span>耗材编码：</label>
                <input type="text" name="materielNo" maxlength="32" lay-verify="required" ms-duplex="consumableNo" :attr="@materielNo">
            </div>
        </div>
        <div class="layui-col-sm6 layui-col-md4 layui-col-lg3">
            <div class="disui-form-flex">
                <label><span class="edit-verify-span">*</span>耗材名称：</label>
        ...
        <div class="layui-form-item layui-hide">
            <button class="layui-btn" lay-submit lay-filter="basConsumableInfoEdit_submit" id="basConsumableInfoEdit_submit">提交
            </button>
        </div>
    </div>
</div>
</div>
<script type="text/javascript" src="${ctxsta}/static/js/base/basConsumableInfoEdit.js?t=${currentTimeMillis}"></script>
</body>
</html>